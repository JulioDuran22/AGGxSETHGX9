...
var handler = async (m, { conn, usedPrefix, command }) => {
  ...
  const ctxWarn = global.rcanalw || { contextInfo: { externalAdReply: { title: '⚠️ Sintaxis', body: 'AGG x ꜱᴇᴛʜɢx9', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Revisión', body: 'AGG x ꜱᴇᴛʜɢx9', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
