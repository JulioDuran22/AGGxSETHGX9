...
global.nomorown = '573212042172@s.whatsapp.net'
...
global.idchannel = '120363419645063496@newsletter'
global.namechannel = '𝆺𝅥 𝆭 ִ ֗ 🍉 AGG x ꜱᴇᴛʜɢx9 ┆ SETHGX9 𝐏𝐫𝐞𝐦𝐁𝐨𝐭 ✨ ౨ৎ˚₊‧'
...
try {
  ...
  global.kontak2 = [
    [owner[0], await conn.getName(owner[0] + '573212042172@s.whatsapp.net'), 'Desarrollador del bot', 'amjulio496@gmail.com', true],
    [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'Desarrollador del bot', 'amjulio496@gmail.com', true],
  ]
  ...
  global.ppkecil = {
    contextInfo: {
      externalAdReply: {
        ...
        title: "𝆺𝅥 𝆭 ִ ֗ 🍉 AGG x ꜱᴇᴛʜɢx9 ┆ SETHGX9 𝐏𝐫𝐞𝐦𝐁𝐨𝐭 ✨ ౨ৎ˚₊‧",
        body: global.author,
  thumbnail: fs.readFileSync("./src/Images/thumbnail.jpg"),
  thumbnailUrl: global.pppkecil,
        sourceUrl: "https://whatsapp.com/channel/0029VbBc97b2ZjCtQ6FSCe1h",
        mediaType: 1,
  ...
  global.adReplyS = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        ...
        body: author,
        mediaUrl: sgc,
        description: "𝆺𝅥 𝆭 ִ ֗ 🍉 AGG x ꜱᴇᴛʜɢx9 ┆ SETHGX9 𝐏𝐫𝐞𝐦𝐁𝐨𝐭 ✨ ౨ৎ˚₊‧",
        previewType: "PHOTO",
  ...
  global.adReply = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        ...
        renderLargerThumbnail: false,
        showAdAttribution: false,
        sourceId: "𝆺𝅥 𝆭 ִ ֗ 🍉 AGG x ꜱᴇᴛʜɢx9 ┆ SETHGX9 𝐏𝐫𝐞𝐦𝐁𝐨𝐭 ✨ ౨ৎ˚₊‧",
        sourceType: "PDF",
        previewType: "PDF",
        sourceUrl: sgc,
        thumbnail: fs.readFileSync("./src/Images/55111188_p0.jpg"),
