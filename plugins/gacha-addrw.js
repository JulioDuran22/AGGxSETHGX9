...
const handler = async (m, { text, usedPrefix, command, conn }) => {
    ...
    const tagNumber = global.owner?.[0]?.[0] + '@s.whatsapp.net' || '573212042172@s.whatsapp.net'

    const jsonMessage = 
        `🍙📋 *AGG - Nuevo Personaje Añadido* ✨\n\n` +
