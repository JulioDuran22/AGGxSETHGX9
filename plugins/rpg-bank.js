let handler = async (m, { conn, usedPrefix }) => {
  ...
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Balance', body: 'AGG x ꜱᴇᴛʜɢx9 ', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
  ...
  const texto = `🍙💰 *AGG x ꜱᴇᴛʜɢx9 - Balance Económico* 📚✨
